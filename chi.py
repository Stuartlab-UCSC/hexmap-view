...
def main (args):
    ...
    and then utilize these contignency tables to compute a chi-squared p-value.
    ...
    # [ [layer1, layer2, binary_layer1, binary_layer2], [l1,l2,b1,b1],...]
    ...
    # Parse the file containing all the hexagon name as a list.
    hex_names = []
    ...
    # Open the writer which fill write three values per line:
    ...
    # hex_names. If the hexagon is found in both layers, account it for 
