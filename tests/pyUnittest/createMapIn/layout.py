...
def hexIt(options):
    ...
    if options.colormaps == None and not(options.scores == None):    #if attributes are not specified then there's no colormaps to create
        new_score_files = []
        combine_files = []
        print 'options.scores:', options.scores
        ...
        print 'options.colormaps:', options.colormaps
        print 'options.directory:', options.directory
        print 'combine_files:', combine_files
