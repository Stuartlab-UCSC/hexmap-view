...
(function (hex) {
    ...
    function create_map () {
        ...
        Meteor.call('create_map', opts, function (error, results) {
            var msg;
            if (error) {
    ...
    function upload_attributes () {
        ...
        if (attribute_upload.file) {
            attribute_upload.upload_now(attribute_upload, function () {
                var msg = attribute_upload.user_file_name + ' has been uploaded.';
                Util.banner('info', msg);
                create_map();
            });
        } else {
    ...
    function username_received (username) {
        ...
        attribute_upload = create_upload($dialog.find('.attribute_upload_anchor'),
            meteor_method, file_name, log);
